...
title: Beautifully display song title
authors: Hoo
---

![Effect picture display](https://github.com/HoowcBN/techdocs_pic/blob/main/design-1.png?raw=true)

 
:::success Previous reminder
To achieve this effect, you only need one HTML and CSS file
:::
### HTML code
```html
<!DOCTYPE html>
...
### CSS code
:::success Previous reminder
Just replace ./picture 图片名称.jpg with your own picture.
:::
